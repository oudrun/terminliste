...
return new class extends Migration {
    public function up(): void
    {
        ...
        if (!Schema::hasTable('trial_classes')) {
        ...
        if (Schema::hasTable('dog_trials') && !Schema::hasColumn('dog_trials', 'updated_at')) {
            Schema::table('dog_trials', function (Blueprint $table): void {
                $table->timestamp('updated_at')->nullable()->after('created_at');
            });
        }

        if (Schema::hasTable('trial_classes') && !Schema::hasColumn('trial_classes', 'updated_at')) {
            Schema::table('trial_classes', function (Blueprint $table): void {
                $table->timestamp('updated_at')->nullable()->after('created_at');
            });
        }

        if (Schema::hasTable('registrations') && !Schema::hasColumn('registrations', 'updated_at')) {
